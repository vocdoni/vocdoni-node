...
var Genesis = map[string]VochainGenesis{
 ...
 `},
	...
	"dev": {
		...
		Genesis: `
{
   "genesis_time":"2020-12-16T08:40:50.512370579Z",
   "chain_id":"vocdoni-development-30",
   "consensus_params":{
      "block":{
         "max_bytes":"10485760",
         "max_gas":"-1",
...
`},
	...
	"dev2": {
		...
		Genesis: `
{
   "genesis_time":"2020-12-01T06:40:50.512370579Z",
   "chain_id":"vocdoni-developmentv2-02",
   "consensus_params":{
      "block":{
         "max_bytes":"22020096",
         "max_gas":"-1",
