...
func TestSetAccountInfoTx(t *testing.T) {
	...
	qt.Assert(t, err, qt.IsNil)
	qt.Assert(t, testSetAccountInfoTx(t,
	...
	faucetPkg = &models.FaucetPackage{Payload: &models.FaucetPayload{}}
	qt.Assert(t, testSetAccountInfoTx(t,
		signers[5], common.Address{}, faucetPkg, app, infoURI, 0),
		qt.IsNotNil,
	)
	...
	faucetPkg, err = GenerateFaucetPackage(signers[0], signers[5].Address(), 5500, rand.Uint64())
	qt.Assert(t, err, qt.IsNil)
	qt.Assert(t, testSetAccountInfoTx(t,
		signers[5], common.Address{}, faucetPkg, app, infoURI, 0),
		qt.IsNotNil,
