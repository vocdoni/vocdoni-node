...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getProcessIDsWithBrokenDateStmt, err = db.PrepareContext(ctx, getProcessIDsWithBrokenDate); err != nil {
		return nil, fmt.Errorf("error preparing query GetProcessIDsWithBrokenDate: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.getProcessIDsWithBrokenDateStmt != nil {
		if cerr := q.getProcessIDsWithBrokenDateStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getProcessIDsWithBrokenDateStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	getProcessIDsWithBrokenDateStmt              *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		getProcessIDsWithBrokenDateStmt:              q.getProcessIDsWithBrokenDateStmt,
