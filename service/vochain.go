...
func Vochain(vconfig *config.VochainCfg, dev, results bool, ma *metrics.Agent) (vnode *vochain.BaseApplication, vclient *voclient.HTTP, sc *scrutinizer.Scrutinizer, vi *vochaininfo.VochainInfo, err error) {
