...
func (r *RPCAPI) EnableCensusAPI(cm *census.Manager) {
...
func (r *RPCAPI) EnableVoteAPI(vocapp *vochain.BaseApplication, vocInfo *vochaininfo.VochainInfo) {
...
func (r *RPCAPI) EnableResultsAPI(vocapp *vochain.BaseApplication,
